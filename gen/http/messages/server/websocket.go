...
//
// messages WebSocket server streaming
//
// Command:
...
// Send streams instances of "messages.Message" to the "subscribe" endpoint
// websocket connection.
func (s *SubscribeServerStream) Send(v *messages.Message) error {
	var err error
