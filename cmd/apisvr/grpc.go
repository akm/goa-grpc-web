...
import (
	...
	messagessvr "goa-grpc-web/gen/grpc/messages/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, messagesEndpoints *messages.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		messagesServer = messagessvr.New(messagesEndpoints, nil, nil)
	}
	...
	messagespb.RegisterMessagesServer(srv, messagesServer)
